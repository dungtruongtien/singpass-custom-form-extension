...
// app/shopify.server.js
var _a, shopify = (0, import_shopify_app_remix.shopifyApp)({
...
var addDocumentResponseHeaders = shopify.addDocumentResponseHeaders, authenticate = shopify.authenticate, login = shopify.login, registerWebhooks = shopify.registerWebhooks, sessionStorage = shopify.sessionStorage;
...
var import_node3 = require("@remix-run/node"), import_tiny_invariant = __toESM(require("tiny-invariant"));

// app/models/QRCode.server.js
var import_qrcode = __toESM(require("qrcode"));
async function getQRCode(id, graphql) {
  let QRCode3 = await db_server_default.qRCode.findFirst({ where: { id } });
  return QRCode3 ? supplementQRCode(QRCode3, graphql) : null;
}
async function getQRCodes(shop, graphql) {
  ...
  return QRCodes.length ? Promise.all(
    QRCodes.map(async (QRCode3) => supplementQRCode(QRCode3, graphql))
  ) : QRCodes;
}
async function getQRCodeImage(id) {
  let { origin } = new URL(process.env.SHOPIFY_APP_URL);
  return `data:image/jpeg;base64, ${(await import_qrcode.default.toBuffer(`${origin}/qrcodes/${id}/scan`)).toString("base64")}`;
}
function getDestinationUrl(QRCode3) {
  if (QRCode3.destination === "product")
    return `https://${QRCode3.shop}/products/${QRCode3.productHandle}`;
  let id = QRCode3.productVariantId.replace(
    /gid:\/\/shopify\/ProductVariant\/([0-9]+)/,
    "$1"
  );
  return `https://${QRCode3.shop}/cart/${id}:1`;
}
async function supplementQRCode(QRCode3, graphql) {
  var _a2, _b, _c, _d;
  ...
  return {
    ...
    productImage: (_b = (_a2 = product.images) == null ? void 0 : _a2.nodes[0]) == null ? void 0 : _b.url,
    productAlt: (_d = (_c = product.images) == null ? void 0 : _c.nodes[0]) == null ? void 0 : _d.altText,
    destinationUrl: getDestinationUrl(QRCode3),
    image: await getQRCodeImage(QRCode3.id)
  };
}
...
var loader = async ({ params }) => {
  (0, import_tiny_invariant.default)(params.id, "Could not find QR code destination");
  let id = Number(params.id), qrCode = await db_server_default.qRCode.findFirst({ where: { id } });
  return (0, import_tiny_invariant.default)(qrCode, "Could not find QR code destination"), await db_server_default.qRCode.update({
    where: { id },
...
async function loader2({ request, params }) {
  ...
  return console.log("admin------", admin), params.id === "new" ? (0, import_node4.json)({
    destination: "product",
    title: ""
...
async function action({ request, params }) {
  ...
  let data = {
    ...
    shop
  }, errors = validateQRCode(data);
  if (errors)
    return (0, import_node4.json)({ errors }, { status: 422 });
  let QRCode3 = params.id === "new" ? await db_server_default.qRCode.create({ data }) : await db_server_default.qRCode.update({ where: { id: Number(params.id) }, data });
  return (0, import_node4.redirect)(`/app/qrcodes/${QRCode3.id}`);
}
function QRCodeForm() {
  var _a2;
  let errors = ((_a2 = (0, import_react4.useActionData)()) == null ? void 0 : _a2.errors) || {}, QRCode3 = (0, import_react4.useLoaderData)(), [formState, setFormState] = (0, import_react3.useState)(QRCode3), [cleanFormState, setCleanFormState] = (0, import_react3.useState)(QRCode3), isDirty = JSON.stringify(formState) !== JSON.stringify(cleanFormState), nav = (0, import_react4.useNavigation)(), isSaving = nav.state === "submitting" && nav.formMethod === "POST", isDeleting = nav.state === "submitting" && nav.formMethod === "DELETE", navigate = (0, import_react4.useNavigate)();
  async function selectProduct() {
    ...
    if (products) {
      ...
      console.log("products-----", JSON.stringify(products)), setFormState({
        ...formState,
        productId: id,
  ...
  function handleSave() {
    ...
    console.log("data------", data), setCleanFormState({ ...formState }), submit(data, { method: "post" });
  }
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Page, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("ui-title-bar", { title: QRCode3.id ? "Edit QR code" : "Create new QR code", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("button", { variant: "breadcrumb", onClick: () => navigate("/app"), children: "QR codes" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Layout, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Layout.Section, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.VerticalStack, { gap: "5", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.VerticalStack, { gap: "5", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.VerticalStack, { gap: "5", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.HorizontalStack, { align: "space-between", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Text, { as: "h2", variant: "headingLg", children: "Product" }, void 0, !1, {
              fileName: "app/routes/app.qrcodes.$id.jsx",
              lineNumber: 161,
              columnNumber: 19
            }, this),
            formState.productId ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Button, { plain: !0, onClick: selectProduct, children: "Change product" }, void 0, !1, {
              fileName: "app/routes/app.qrcodes.$id.jsx",
              lineNumber: 165,
              columnNumber: 21
            }, this) : null
          ...
          formState.productId ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.HorizontalStack, { blockAlign: "center", gap: "5", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            ...
            lineNumber: 171,
            columnNumber: 19
          }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.VerticalStack, { gap: "2", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Bleed, { marginInline: "20", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Divider, {}, void 0, !1, {
            fileName: "app/routes/app.qrcodes.$id.jsx",
            lineNumber: 194,
            columnNumber: 19
          }, this) }, void 0, !1, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            import_polaris.HorizontalStack,
            {
              gap: "5",
              align: "space-between",
              blockAlign: "start",
              children: [
                ...
                QRCode3.destinationUrl ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Button, { plain: !0, url: QRCode3.destinationUrl, external: !0, children: "Go to destination URL" }, void 0, !1, {
                  fileName: "app/routes/app.qrcodes.$id.jsx",
                  lineNumber: 220,
                  columnNumber: 21
                }, this) : null
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Layout.Section, { secondary: !0, children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Card, { children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.Text, { as: "h2", variant: "headingLg", children: "QR code" }, void 0, !1, {
          fileName: "app/routes/app.qrcodes.$id.jsx",
          lineNumber: 231,
          columnNumber: 13
        }, this),
        QRCode3 ? /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.EmptyState, { image: QRCode3.image, imageContained: !0 }, void 0, !1, {
          fileName: "app/routes/app.qrcodes.$id.jsx",
          lineNumber: 235,
          columnNumber: 15
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(import_polaris.VerticalStack, { gap: "3", children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
            import_polaris.Button,
            {
              disabled: !(QRCode3 != null && QRCode3.image),
              url: QRCode3 == null ? void 0 : QRCode3.image,
              download: !0,
              primary: !0,
              children: "Download"
            },
          ...
          secondaryActions: [
            {
              content: "Delete",
              loading: isDeleting,
              disabled: !QRCode3.id || !QRCode3 || isSaving || isDeleting,
              destructive: !0,
              outline: !0,
...
var import_node5 = require("@remix-run/node"), import_tiny_invariant2 = __toESM(require("tiny-invariant")), import_react5 = require("@remix-run/react");
var import_jsx_dev_runtime5 = require("react/jsx-dev-runtime"), loader3 = async ({ params }) => {
  ...
  let id = Number(params.id), qrCode = await db_server_default.qRCode.findFirst({ where: { id } });
  return (0, import_tiny_invariant2.default)(qrCode, "Could not find QR code destination"), (0, import_node5.json)({
    title: qrCode.title,
...
function Index() {
  ...
  let emptyMarkup = QRCodes.length ? null : /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(
    ...
    this
  ), qrCodesMarkup = QRCodes.length ? /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(
    import_polaris3.IndexTable,
    {
      ...
      children: QRCodes.map(
        ({
          ...
          createdAt,
          scans
        }) => /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.IndexTable.Row, { id, position: id, children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.IndexTable.Cell, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(
            ...
            {
              source: productImage || import_polaris_icons2.ImageMajor,
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.IndexTable.Cell, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_react6.Link, { to: `qrcodes/${id}`, children: truncate(title) }, void 0, !1, {
            fileName: "app/routes/app._index.jsx",
            lineNumber: 88,
            columnNumber: 17
          }, this) }, void 0, !1, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.IndexTable.Cell, { children: productDeleted ? /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.HorizontalStack, { align: "start", gap: "2", children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Tooltip, { content: "product has been deleted", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("span", { style: { width: "20px" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Icon, { source: import_polaris_icons2.DiamondAlertMajor, color: "critical" }, void 0, !1, {
              fileName: "app/routes/app._index.jsx",
              lineNumber: 95,
              columnNumber: 25
            }, this) }, void 0, !1, {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Text, { color: productDeleted && "critical", as: "span", children: truncate(productTitle) }, void 0, !1, {
              fileName: "app/routes/app._index.jsx",
              lineNumber: 98,
              columnNumber: 21
            }, this)
            ...
            lineNumber: 92,
            columnNumber: 19
          }, this) : truncate(productTitle) }, void 0, !1, {
            fileName: "app/routes/app._index.jsx",
            lineNumber: 90,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.IndexTable.Cell, { children: new Date(createdAt).toDateString() }, void 0, !1, {
            fileName: "app/routes/app._index.jsx",
            lineNumber: 106,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.IndexTable.Cell, { children: scans }, void 0, !1, {
            fileName: "app/routes/app._index.jsx",
            lineNumber: 109,
            columnNumber: 15
          }, this)
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Page, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Layout, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Layout.Section, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_polaris3.Card, { padding: "0", children: [
      emptyMarkup,
      qrCodesMarkup
    ] }, void 0, !0, {
      fileName: "app/routes/app._index.jsx",
...
function Auth() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(import_polaris4.AppProvider, { i18n: polarisTranslations, children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(import_polaris4.Page, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(import_polaris4.Card, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(import_react8.Form, { method: "post", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(import_polaris4.FormLayout, { children: [
...
var test_login_exports = {};
__export(test_login_exports, {
  default: () => QRCode2,
  loader: () => loader6
});
var import_node8 = require("@remix-run/node"), import_tiny_invariant3 = require("tiny-invariant"), import_react9 = require("@remix-run/react");
var import_jsx_dev_runtime8 = require("react/jsx-dev-runtime"), loader6 = async ({ params }) => (0, import_node8.json)({
  title: "",
  image: ""
});
function QRCode2() {
...
// app/routes/_index/route.jsx
var import_jsx_dev_runtime9 = require("react/jsx-dev-runtime"), links2 = () => [{ rel: "stylesheet", href: style_default }];
...
function App2() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "index", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "content", children: [
    ...
    showForm && /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(import_react10.Form, { method: "post", action: "/auth/login", children: [
...
var import_react11 = __toESM(require("react")), import_node10 = require("@remix-run/node"), import_react12 = require("@remix-run/react"), import_polaris5 = require("@shopify/polaris");
...
async function loader9({ request }) {
  return await authenticate.admin(request), (0, import_node10.json)({
    polarisTranslations: require("@shopify/polaris/locales/en.json"),
    apiKey: process.env.SHOPIFY_API_KEY
  });
}
function App3() {
  let { apiKey, polarisTranslations } = (0, import_react12.useLoaderData)();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(import_jsx_dev_runtime10.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
      import_polaris5.AppProvider,
      {
        i18n: polarisTranslations,
        linkComponent: RemixPolarisLink,
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(import_react12.Outlet, {}, void 0, !1, {
          fileName: "app/routes/app.jsx",
          lineNumber: 40,
          columnNumber: 9
        }, this)
...
var RemixPolarisLink = import_react11.default.forwardRef(
  (props, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(import_react12.Link, { ...props, to: props.url ?? props.to, ref, children: props.children }, void 0, !1, {
    fileName: "app/routes/app.jsx",
    lineNumber: 48,
    columnNumber: 1
  }, this)
...
function ErrorBoundary() {
  return import_shopify_app_remix3.boundary.error((0, import_react12.useRouteError)());
}
var headers = (headersArgs) => import_shopify_app_remix3.boundary.headers(headersArgs);

// server-assets-manifest:@remix-run/dev/assets-manifest
var assets_manifest_default = { entry: { module: "/build/entry.client-FRBXFW2I.js", imports: ["/build/_shared/chunk-ZWGWGGVF.js", "/build/_shared/chunk-GIAAE3CH.js", "/build/_shared/chunk-GKDIEDO4.js", "/build/_shared/chunk-XU7DNSPJ.js", "/build/_shared/chunk-BOXFZXVX.js", "/build/_shared/chunk-EF6FZ7HG.js", "/build/_shared/chunk-UWV35TSL.js", "/build/_shared/chunk-PNG5AS42.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-TKFULXMW.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-VY5A33LS.js", imports: ["/build/_shared/chunk-3GJP5LZF.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/app": { id: "routes/app", parentId: "root", path: "app", index: void 0, caseSensitive: void 0, module: "/build/routes/app-VDVAVQAL.js", imports: ["/build/_shared/chunk-NMZL6IDN.js", "/build/_shared/chunk-SU66BP3D.js", "/build/_shared/chunk-D2XBXINQ.js", "/build/_shared/chunk-7OKZO5D7.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !0 }, "routes/app._index": { id: "routes/app._index", parentId: "routes/app", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/app._index-UYI2VNFN.js", imports: ["/build/_shared/chunk-3EYAZZDZ.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/app.additional": { id: "routes/app.additional", parentId: "routes/app", path: "additional", index: void 0, caseSensitive: void 0, module: "/build/routes/app.additional-TXIKULY6.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/app.qrcodes.$id": { id: "routes/app.qrcodes.$id", parentId: "routes/app", path: "qrcodes/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/app.qrcodes.$id-FS4RGXZJ.js", imports: ["/build/_shared/chunk-DXZPNPAJ.js", "/build/_shared/chunk-3EYAZZDZ.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/auth.$": { id: "routes/auth.$", parentId: "root", path: "auth/*", index: void 0, caseSensitive: void 0, module: "/build/routes/auth.$-4B5WQABX.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/auth.login": { id: "routes/auth.login", parentId: "root", path: "auth/login", index: void 0, caseSensitive: void 0, module: "/build/routes/auth.login-ZFV2JDXG.js", imports: ["/build/_shared/chunk-3GJP5LZF.js", "/build/_shared/chunk-D2XBXINQ.js", "/build/_shared/chunk-7OKZO5D7.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/qrcodes.$id": { id: "routes/qrcodes.$id", parentId: "root", path: "qrcodes/:id", index: void 0, caseSensitive: void 0, module: "/build/routes/qrcodes.$id-OJTJC5HQ.js", imports: ["/build/_shared/chunk-DXZPNPAJ.js", "/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/qrcodes.$id.scan": { id: "routes/qrcodes.$id.scan", parentId: "routes/qrcodes.$id", path: "scan", index: void 0, caseSensitive: void 0, module: "/build/routes/qrcodes.$id.scan-2CY3SXY7.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/test-login": { id: "routes/test-login", parentId: "root", path: "test-login", index: void 0, caseSensitive: void 0, module: "/build/routes/test-login-SDDBIU4D.js", imports: ["/build/_shared/chunk-G7CHZRZX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/webhooks": { id: "routes/webhooks", parentId: "root", path: "webhooks", index: void 0, caseSensitive: void 0, module: "/build/routes/webhooks-JFV2P4HI.js", imports: void 0, hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, version: "72e217ec", hmr: { runtime: "/build/_shared/chunk-EF6FZ7HG.js", timestamp: 1693709847543 }, url: "/build/manifest-72E217EC.js" };

// server-entry-module:@remix-run/dev/server-build
var assetsBuildDirectory = "public/build", future = { v2_dev: { port: "57818" }, unstable_postcss: !1, unstable_tailwind: !1, v2_errorBoundary: !0, v2_headers: !0, v2_meta: !0, v2_normalizeFormMethod: !0, v2_routeConvention: !0 }, publicPath = "/build/", entry = { module: entry_server_exports }, routes = {
  root: {
    id: "root",
    parentId: void 0,
    path: "",
  ...
  "routes/test-login": {
    id: "routes/test-login",
    parentId: "root",
    path: "test-login",
    index: void 0,
    caseSensitive: void 0,
    module: test_login_exports
  },
  "routes/webhooks": {
    id: "routes/webhooks",
    parentId: "root",
